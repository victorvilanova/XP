...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma contêm as mensagens de erro padrão utilizadas
    ...
    */
    ...
    | a convenção "attribute.rule". Isso permite personalizar rapidamente
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas são usadas para substituir os placeholders de atributo
